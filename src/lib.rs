...
#[derive(Debug)]
pub struct CouchdbNanoProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CouchdbNanoProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CouchdbNano processing");
    
    let mut processor = CouchdbNanoProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CouchdbNanoProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CouchdbNanoProcessor::new(false);
